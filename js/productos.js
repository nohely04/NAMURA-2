function detalleProductos(id) {
    window.location.href = `detalleProductos.html?id=${id}`; /*redirecciona al lugar que indique el id */
  }
function displayProductos(data){
    ...
    data.forEach(producto => {
        ...
        <div class="card-body">
          ...
          <a href="#" class="btn btn-primary btn-lg  detalle onclick=detalleProductos(${producto.id})">Detalle</a>
        </div>
         </div>
      </div>`
      prod.append()
